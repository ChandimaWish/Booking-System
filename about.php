		...
		<div class="content-top">
				<div class="section group">
					<div class="about span_1_of_2">	
						<h3 style="color:#444; font-size:27px; font-weight: bold;" class="text-center"><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
								<div class="grid images_3_of_2">
									<img src="<?php echo $movie['image']; ?>" alt=""/>
								</div>
								<div class="desc span_3_of_2">
									<p class="p-link" style="font-size:20px"><b>Cast : </b><?php echo $movie['cast']; ?></p>
									<p class="p-link" style="font-size:18px"><b>Release Date : </b><?php echo date('d-M-Y',strtotime($movie['release_date'])); ?></p>
							...
							<table class="table table-hover table-bordered text-center">
								...
								<thead>
										<tr>
											...
											<th class="text-center" style="font-size:16px;"><b>SHOWTIMES</b></th>
										</tr>
									</thead>
							<?php
